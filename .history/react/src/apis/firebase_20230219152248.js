...
import { getDatabase, ref, set, onValue, get, update, orderByChild, query } from "firebase/database";
...
export async function getMeetsDataWithSorting(){
  const meetRef = ref(db, 'meets/');
  const mostImminentMeets = query(meetRef, orderByChild('meetTime/time'));
  console.log(mostImminentMeets);
}
