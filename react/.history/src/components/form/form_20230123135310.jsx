      ...
      <form className={styles.form}>
        <div className={styles.locationContainer}>
          <div className={styles.departure}>
            ...
            <input type="text" id='departure' name='departure' maxLength='12' onChange={handleChange}/>
            <FaSearch className={styles.searchIcon}/>
          </div>
          <div className={styles.arrival}>
            <label className={styles.formLabel} htmlFor='arrival'>도착지</label>
            <input type="text" id='arrival' name='arrival' maxLength='12' onChange={handleChange}/>
            <FaSearch className={styles.searchIcon}/>
          </div>
        </div>
