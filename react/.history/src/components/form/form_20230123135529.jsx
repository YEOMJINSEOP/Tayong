      ...
      <form className={styles.form}>
        <div className={styles.locationContainer}>
          <div className={styles.departure}>
            ...
            <input readOnly value={params.departure} type="text" id='departure' name='departure' maxLength='12' />
            <FaSearch className={styles.searchIcon}/>
          </div>
          <div className={styles.arrival}>
            <label readOnly value={params.arrival} className={styles.formLabel} htmlFor='arrival'>도착지</label>
