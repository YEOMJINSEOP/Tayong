...
function Form(props) {
  ...
  const [meet, setMeet]= useState({meetId: '', host: '', departure, arrival, Time: '', recruitment: 0, transport: '', title: '', content: ''})
      ...
      <form className={styles.form}>
        ...
        <div className={styles.infoContainer}>
          ...
          <div className={styles.meetTime}>
            <label className={styles.formLabel} htmlFor='remainingTime'>출발시각</label>
